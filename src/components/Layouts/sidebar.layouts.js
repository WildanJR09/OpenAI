  ...
  return (
    ...
    >
      <div className={`flex items-center`}>
        ...
        />
        <div
          className={`text-black origin-left font-medium text-2xl duration-200 ml-1.5 mt-8 md:mt-7 ${!open && "scale-0"
            }`}
        >
      ...
      >
        <FontAwesomeIcon
          icon="{faInfoCircle}"
          className={`text-base md:text-lg md:mr-6 text-black ${open && "hidden"
        ...
        >
          ...
          <div className={`${!open && "hidden"}`}>
            <p className={`mb-3 text-xs md:text-sm`}>
              Made by WildanJR09, All Rights Reserved.
            </p>
            <a
